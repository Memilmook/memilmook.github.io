...
const Meta = ({ data }) => {
  ...
  return (
    <Helmet titleTemplate="%s">
      ...
      <meta property="og:site_name" content="메밀묵 Github 블로그 블로그" />
      ...
      <meta property="fb:pages" content="메밀묵 Github 블로그 블로그" />
      ...
      <meta name="twitter:site" content="@메밀묵 Github 블로그 블로그" />
